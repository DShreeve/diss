...
\par STRUCTURE INFORMATION REQUIRED INTO DB DIAGRAM

\par FIG: DATABASE DIAGRAM

\par MOCKUP OF HOW INFO SHOULD BE ENTERED/ EDITED

\par FIG OF MOCKUP

\par HOW TESTS SHOULD BE GENERATED

\par FIG OF THAT BUTTON

\par HOW INFORMATION SHOULD BE PRESENTED

\par RSPEC TEMPLATE DESIGN 

\par FIG: FLOW CHART OF PATH FOR GEN A TEST CASE

\par EXPLAIN FLOW CHART

\par STRING GENERATION FLOW CHART

\par EXPLAIN FLOW CHART

\par NUMBER GENERATION FLOW CHART

\par EXPLAIN FLOW CHART

\par OVERALL FLOW CHART

\par EXPLAIN FLOW CHART

\section{Chapter 5: Implemention and Testing}

\par FOR DESIGN ASPECT .EACH DO |D|
\par EXPLAIN HOW IMPLEMENTED
\par ANY CHALLENGES \ VARIATION

\par TESTING
\par FOR EACH REQUIREMENT IN CHP 3 SAY IF MET OR NOT, HOW IT WAS TESTED
